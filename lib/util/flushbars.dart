...
class Flushbars {
  static void showFloatingFlushBar(BuildContext context, String title, String? message, Icon icons, bool isSuccess) {
    Flushbar(
  ...
  static Flushbar showLoadingFlushbar(BuildContext context, String message) {
    return Flushbar(
      margin: const EdgeInsets.all(10.0),
      padding: const EdgeInsets.all(10),
      borderRadius: const BorderRadius.all(Radius.circular(8)),
  ...
  static Flushbar showFailure(String message, {String? title}) {
    return Flushbar(
        margin: const EdgeInsets.fromLTRB(10, 10, 10, 20),
        borderRadius: const BorderRadius.all(Radius.circular(8)),
        titleText: Text(title ?? "Error", style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20)),
        messageText: Text(message, style: const TextStyle(color: Colors.white, fontSize: 16)),
        duration: const Duration(seconds: 2),
